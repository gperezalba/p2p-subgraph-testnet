...
export class NameService extends SmartContract {
  ...
  nameIsAvailable(_name: string): boolean {
  ...
  try_nameIsAvailable(_name: string): CallResult<boolean> {
  ...
  nameIsAvailable1(_nameHash: Bytes): boolean {
    let result = super.call("nameIsAvailable", [
  ...
  try_nameIsAvailable1(_nameHash: Bytes): CallResult<boolean> {
    let result = super.tryCall("nameIsAvailable", [
      EthereumValue.fromFixedBytes(_nameHash)
    ]);
    if (result.reverted) {
